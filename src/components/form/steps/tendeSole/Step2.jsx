...
export default function StepTendeSole({ onNext, onBack, formData }) {
  ...
  return (
    <div className="space-y-6 bg-white mx-auto h-[500px] flex flex-col justify-between">
      <div className="flex flex-col gap-4">
        <h2 className='text-2xl font-semibold text-gray-800'>Hai già delle tende da sole?</h2>
        {['No, vorrei installarle', 'Si, ma vorrei cambiarle', 'Si, devo solo cambiare il telo'].map((option) => (
